...
window.CITY = (() => {
  const people = {
    gu: { name: "顾砚", age: 30, job: "科技公司创始人 · 上海 / 东京", image: "gu", intro: "中日混血，东京大学毕业。少年时被称作天才，创办的科技公司专注辅助导航。他习惯迅速答对问题，却不擅长听见答题纸以外的声音。会被认真而笨拙的努力吸引，也必须学会尊重一个与自己不同的答案。", history: "父亲是中国人，母亲是日本人。他来上海不是为了赢下一轮融资，而是为了寻找一段被自己亲手删除的产品测试记录。那个被他指责泄密的人，曾替他保住一条他并不知情的退路。" },
    zhou: { name: "周予白", age: 28, job: "飞行器制造工程师 · 上海", image: "zhou", intro: "你的高中同学，也是你曾偷偷喜欢的人。他的优秀来自重复、耐心与不会被老师看见的深夜。重逢后依然话少，依然会在下雨前多带一把伞。", history: "他习惯先解决别人的需要，最后才想自己。他保存了一本你早已忘记的练习册；有些藏在页边的答案，比题目晚了十年。" },
    lu: { name: "陆星野", age: 24, job: "演员 · 北京 / 重庆", image: "lu", intro: "镜头认识他的笑，鲜有人认识他不笑的时候。父母很早离异，辗转的住处教会他做一个让每个人都轻松的小孩。如今是顶流，仍会在结束通告后偷偷查重庆末班地铁。", history: "他想公开喜欢一个人，又不想把被喜欢的人交给公共审判。姐姐只是一个称呼；他希望承担的是一个成年伴侣的责任。" },
    wen: { name: "闻照", age: 26, job: "青年助理教授 · 深圳", image: "wen", intro: "香港中文大学（深圳）的年轻教师，研究公共设计与技术伦理。比你小两岁，资质并不出众，却在接连出现的机会里走得很快。他知道幸运不是能力，也害怕别人发现这一点。", history: "回声项目让他得到位置，也把他放进校内项目办公室与城市更新部门的争执。他的银发是一次展览造型留下的颜色，不是什么超自然秘密。角色及校政项目情节均为虚构。" }
  };
  const assets = {
    lz1: "你的春日肖像", lz2: "好友 · 林见微", lz3: "顾砚 · 樱花下的距离", lz4: "顾砚 · 留下的问题",
